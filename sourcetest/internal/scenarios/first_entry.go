	...
	Scenarios = append(Scenarios,
		Scenario{
			...
			Verif: []string{
				...
				"0_attrs.0_funcs_func.active=true",
				"0_attrs.0_funcs_func.name=func",
				"0_attrs.0_funcs_func.null=false",
				"0_attrs.0_funcs_func.set=0_funcs",
				"0_attrs.0_funcs_func.type=string",
				...
				"0_funcs._not_implemented.func=func(snap *Snapshot) error {\n\t\t\t\tsnap.Fail(ErrNotImplemented)\n\t\t\t}",
				...
				"0_rels.0_funcs_create_func.active=true",
				"0_rels.0_funcs_create_func.inverse=0_sets_rels",
				"0_rels.0_funcs_create_func.name=create_func",
				"0_rels.0_funcs_create_func.set=0_funcs",
				"0_rels.0_funcs_create_func.to-one=true",
				"0_rels.0_funcs_delete_func.active=true",
				"0_rels.0_funcs_delete_func.inverse=0_sets_rels",
				"0_rels.0_funcs_delete_func.name=delete_func",
				"0_rels.0_funcs_delete_func.set=0_funcs",
				"0_rels.0_funcs_delete_func.to-one=true",
				"0_rels.0_funcs_get_func.active=true",
				"0_rels.0_funcs_get_func.inverse=0_sets_rels",
				"0_rels.0_funcs_get_func.name=get_func",
				"0_rels.0_funcs_get_func.set=0_funcs",
				"0_rels.0_funcs_get_func.to-one=true",
				"0_rels.0_funcs_update_func.active=true",
				"0_rels.0_funcs_update_func.inverse=0_sets_rels",
				"0_rels.0_funcs_update_func.name=update_func",
				"0_rels.0_funcs_update_func.set=0_funcs",
				"0_rels.0_funcs_update_func.to-one=true",
				...
				"0_rels.0_sets_create_func.active=true",
				"0_rels.0_sets_create_func.inverse=",
				"0_rels.0_sets_create_func.name=create_func",
				"0_rels.0_sets_create_func.set=0_funcs",
				"0_rels.0_sets_create_func.to-one=true",
				"0_rels.0_sets_delete_func.active=true",
				"0_rels.0_sets_delete_func.inverse=",
				"0_rels.0_sets_delete_func.name=delete_func",
				"0_rels.0_sets_delete_func.set=0_funcs",
				"0_rels.0_sets_delete_func.to-one=true",
				"0_rels.0_sets_get_func.active=true",
				"0_rels.0_sets_get_func.inverse=",
				"0_rels.0_sets_get_func.name=get_func",
				"0_rels.0_sets_get_func.set=0_funcs",
				"0_rels.0_sets_get_func.to-one=true",
				...
				"0_rels.0_sets_update_func.active=true",
				"0_rels.0_sets_update_func.inverse=",
				"0_rels.0_sets_update_func.name=update_func",
				"0_rels.0_sets_update_func.set=0_funcs",
				"0_rels.0_sets_update_func.to-one=true",
				...
				"0_sets.0_funcs.active=true",
				"0_sets.0_funcs.attrs=0_funcs_func",
				"0_sets.0_funcs.name=0_funcs",
				"0_sets.0_funcs.rels=0_funcs_set",
				"0_sets.0_funcs.version=0",
				...
				"0_sets.0_sets.rels=0_sets_attrs,0_sets_rels,0_funcs_get_func,0_funcs_create_func,0_funcs_update_func,0_funcs_delete_func",
